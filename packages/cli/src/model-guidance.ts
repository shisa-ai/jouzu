...
export function buildModelGuidance(modelId: string | undefined, selectedTools: readonly string[] = []): string {
	...
	const guidance = [
		...
		"Treat requests such as 'can you' or 'help me' as instructions to do the work. Carry authorized work through implementation and required verification. Resolve routine choices from context; ask only when missing information materially affects correctness or authorization. Continue independent work while awaiting an answer.",
