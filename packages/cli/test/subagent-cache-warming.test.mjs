...
for (const mode of [undefined, "off", "streaming", "idle"])
	test(`child warming usage and configured mode stay isolated: ${mode ?? "default"}`, { timeout: 20_000 }, async () => {
